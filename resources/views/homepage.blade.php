...
<body>
    ...
    <ul class="nav navbar-nav">
          <li><a href="/home" class="xyz active">Home</a></li>
...
div class="container" style="width:100%;padding-top:0px;">
	<div class="row">
		<div class="col-sm-12" style="height:600px;background-image: url('file:///C:/Users/nehar/Desktop/neha.png');background-repeat: no repeat;">
			aaabbababb<br><br><br><br><br><br><br><br>
		</div>
